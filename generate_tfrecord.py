# -*- coding: utf-8 -*-
# python generate_tfrecord.py --txt_input=dataset/test.txt  --output_path=data/test.record
# python generate_tfrecord.py --txt_input=dataset/train.txt  --output_path=data/train.record
